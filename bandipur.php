...
<body>
  <div class="container">
    ...
    <form action="bandipur-ticket.php" method="POST" onsubmit="return confirm('Confirm booking?');">
      <input type="text" name="name" placeholder="Enter your Name" pattern="[A-Za-z\s]+" required>
      <input type="text" name="tour" value="Bandipur Safari" readonly>
      <input type="text" name="validation_date" value="24-05-2025" readonly>
