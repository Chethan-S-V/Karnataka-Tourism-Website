...
$checkSeats = "SELECT COUNT(*) AS total FROM kudremukh WHERE tour = '$tour'";
...
// Insert booking
$sql = "INSERT INTO kudremukh (name, tour, validation_date, seat_type, validation_time)
...
if ($conn->query($sql) === TRUE) {
    ...
    header("Location: kudremukhbooking.php?id=$last_id");
} else {
