...
$checkSeats = "SELECT COUNT(*) AS total FROM bandipur WHERE tour = '$tour'";
...
// Insert booking
$sql = "INSERT INTO bandipur (name, tour, validation_date, seat_type, validation_time)
...
if ($conn->query($sql) === TRUE) {
    ...
    header("Location: bandipurbooking.php?id=$last_id");
} else {
