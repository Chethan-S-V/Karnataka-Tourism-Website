...
$checkSeats = "SELECT COUNT(*) AS total FROM hampi_temples WHERE tour = '$tour'";
...
// Insert booking
$sql = "INSERT INTO hampi_temples (name, tour, validation_date, seat_type, validation_time)
...
if ($conn->query($sql) === TRUE) {
    ...
    header("Location: templesbooking.php?id=$last_id");
} else {
