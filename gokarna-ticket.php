...
$checkSeats = "SELECT COUNT(*) AS total FROM gokarna WHERE tour = '$tour'";
...
// Insert booking
$sql = "INSERT INTO gokarna (name, tour, validation_date, seat_type, validation_time)
...
if ($conn->query($sql) === TRUE) {
    ...
    header("Location: gokarnabooking.php?id=$last_id");
} else {
