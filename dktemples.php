...
<body>
  <div class="container">
    ...
    <form action="dktemples-ticket.php" method="POST" onsubmit="return confirm('Confirm booking?');">
      <input type="text" name="name" placeholder="Enter your Name" pattern="[A-Za-z\s]+" required>
      <input type="text" name="tour" value="DakshinaKannada Temples" readonly>
      <input type="text" name="validation_date" value="20-05-2025" readonly>
