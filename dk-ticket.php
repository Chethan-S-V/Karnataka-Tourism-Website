...
$checkSeats = "SELECT COUNT(*) AS total FROM dk WHERE tour = '$tour'";
...
// Insert booking
$sql = "INSERT INTO dk (name, tour, validation_date, seat_type, validation_time)
...
if ($conn->query($sql) === TRUE) {
    ...
    header("Location: dkbooking.php?id=$last_id");
} else {
