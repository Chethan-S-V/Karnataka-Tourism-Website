...
$checkSeats = "SELECT COUNT(*) AS total FROM hampi WHERE tour = '$tour'";
...
// Insert booking
$sql = "INSERT INTO hampi (name, tour, validation_date, seat_type, validation_time)
...
if ($conn->query($sql) === TRUE) {
    ...
    header("Location: hampibooking.php?id=$last_id");
} else {
