...
$checkSeats = "SELECT COUNT(*) AS total FROM dk_temples WHERE tour = '$tour'";
...
// Insert booking
$sql = "INSERT INTO dk_temples (name, tour, validation_date, seat_type, validation_time)
...
if ($conn->query($sql) === TRUE) {
    ...
    header("Location: dktemplesbooking.php?id=$last_id");
} else {
